...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_NUM] = LAYOUT_ortho_5x5(
        ...
        KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_LBRC,
        KC_P4,   KC_P5,   KC_P6,   KC_EQL,  KC_RBRC,
        KC_P1,   KC_P2,   KC_P3,   KC_ENT,  KC_SPC,
        KC_P0,   KC_DOT,  KC_SLSH, KC_ENT,  KC_LANG1),

    [_NUMOFF] = LAYOUT_ortho_5x5(
        _______, KC_PSLS, KC_PAST, KC_PMNS, KC_BSPC,
        KC_AMPR, KC_UP,   _______, KC_PPLS, KC_LBRC,
        KC_LEFT, XXXXXXX, KC_RGHT, KC_EQL,  KC_RBRC,
        KC_END,  KC_DOWN, KC_HASH, KC_ENT,  KC_SPC,
        _______, KC_DOT,  KC_DEL,  KC_ENT,  KC_LANG1),
