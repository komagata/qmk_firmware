...
#define KC_LOMH LT(KC_LGUI, KC_LANG2)
#define KC_RAHE LT(KC_RGUI, KC_LANG1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_LCTL,    KC_LALT,    KC_LGUI,    KC_SPC,        KC_ENT, KC_RGUI,  KC_SPC,                    KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
